        ...
        <div class="grid p-fluid">
          <div class="col-12 lg:col-6">
            ...
            <InputText
              ...
              :useGrouping="false"
              :class="{ 'p-invalid': collectiontype_valid.state.name }"
            />
            <small v-if="collectiontype_valid.state.name" class="p-error">{{
              collectiontype_valid.msg.name
            }}</small>
          </div>
          <div class="col-12 lg:col-6">
            <h5>Amount</h5>
            <InputNumber
              ...
              currency="PHP"
              :useGrouping="false"
              :class="{ 'p-invalid': collectiontype_valid.state.amount }"
              :min="1"
            />
            <small v-if="collectiontype_valid.state.amount" class="p-error">{{
              collectiontype_valid.msg.amount
            }}</small>
          </div>
        </div>
        <template #footer>
        ...
        <div class="confirmation-content">
          <div class="grid">
            <div class="col-12 flex align-items-center justify-content-center">
              ...
              />
              <span
                >Are you sure you want to delete <b>{{ add_collectiontype.name }}</b
                >?</span
              >
            </div>
          </div>
