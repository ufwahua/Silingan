  ...
  <div>
    ...
    <div class="card">
      ...
      >
        ...
        <Column field="collection_type.name" header="Source"></Column>
    ...
    >
      <div class="grid p-fluid">
        <div class="col-12 lg:col-6">
          ...
          />
          <small v-if="revenue_valid.state.collection_type" class="p-error">{{revenue_valid.msg.collection_type}}</small>
        </div>
        <div class="col-12 lg:col-6">
          <h5>Amount</h5>
          <InputNumber
          ...
          />
          <small v-if="revenue_valid.state.amount" class="p-error">{{revenue_valid.msg.amount}}</small>
        </div>
        <div class="col-12 lg:col-6">
          <h5>Block</h5>
          <Dropdown
          ...
          />
          <small v-if="revenue_valid.state.block" class="p-error">{{revenue_valid.msg.block}}</small>
        </div>
        <div class="col-12 lg:col-6">
          <h5>Lot</h5>
          <Dropdown
          ...
          />
          <small v-if="revenue_valid.state.lot" class="p-error">{{revenue_valid.msg.lot}}</small>
        </div>
        <div class="col-12">
          <h5>Notes</h5>
  ...
  methods: {
    ...
    showSuccess() {
      this.$toast.add({
        ...
        detail: "Successfully Added Revenue",
        life: 3000,
      });
    },
    addRevenue() {
    ...
    revenueFormError(e){
      ...
      if(e.errors.collection_type_id){
        ...
        this.revenue_valid.msg.collection_type = "The collection type field is required."
      }
