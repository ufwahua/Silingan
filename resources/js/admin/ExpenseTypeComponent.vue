        ...
        <div class="grid p-fluid">
          <div class="col-12 lg:col-6">
            ...
            <InputText
              ...
              :useGrouping="false"
              :class="{ 'p-invalid': expensetype_valid.state.name }"
            />
            <small v-if="expensetype_valid.state.name" class="p-error">{{
              expensetype_valid.msg.name
            }}</small>
          </div>
        </div>
        <template #footer>
        ...
        <div class="confirmation-content">
          <div class="grid">
            <div class="col-12 flex align-items-center justify-content-center">
              ...
              />
              <span
                >Are you sure you want to delete <b>{{ add_expensetype.name }}</b
                >?</span
              >
            </div>
          </div>
